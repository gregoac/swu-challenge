...
1. Install PostgreSQL and the PostGIS extension. To do so, follow this steps: https://postgis.net/workshops/postgis-intro/installation.html.
2. Create a spatial database. To do so, follow this steps: https://postgis.net/workshops/postgis-intro/creating_db.html.
